  ...
  test(
    ...
    () {
      ...
      controller.liveConversationMessagesByScope = {
        'session:codex:session-1': liveTurn,
      };
      ...
      expect(
        controller.liveConversationMessagesByScope['session:codex:session-1'],
        liveTurn,
      );
      ...
      expect(
        controller.liveConversationMessagesByScope.containsKey(
