...
const Set<ClientSection> dashboardMobileExpectedDestinations = <ClientSection>{
  ClientSection.agents,
  ClientSection.mobileRelay,
  ClientSection.settings,
};

LayoutPalette dashboardMobileTestPalette(BuildContext context) {
...
/// assertions.
final class DashboardMobileHarness {
  ...
  void selectDestination(ClientSection destination) {
    if (!dashboardMobileExpectedDestinations.contains(destination)) {
...
final class DashboardMobileFixtureContent
    implements LayoutDestinationContentPort {
  DashboardMobileFixtureContent(this.harness);

  final DashboardMobileHarness harness;
...
final class DashboardMobileTestShell extends StatelessWidget {
  const DashboardMobileTestShell({
    super.key,
  ...
  final DashboardMobileFixtureContent content;
  final DashboardMobileHarness harness;
          ...
          child: MediaQuery(
            ...
            child: Builder(
              builder: (paletteContext) => LayoutPaletteScope(
                palette: dashboardMobileTestPalette(paletteContext),
                child: LayoutScope(
...
LayoutEnvironment dashboardMobileEnvironment({
...
void configureDashboardMobileTestView(WidgetTester tester, Size size) {
