...
LayoutPalette studioMobileTestPalette(BuildContext context) {
...
Widget withStudioMobileTestPalette(BuildContext context, Widget child) =>
    LayoutPaletteScope(palette: studioMobileTestPalette(context), child: child);
