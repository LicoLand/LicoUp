...
const String workbenchMobilePreviewSemanticLabel =
    'layout.profile.workbench.label';

/// Metadata-only preview: the shapes describe the Workbench composition but
/// never consume live feature state, user content, or backend data.
Widget buildWorkbenchMobilePreview(BuildContext context) {
  final colors = Theme.of(context).colorScheme;
  return Semantics(
    key: const ValueKey<String>('workbench-mobile-preview'),
    container: true,
    image: true,
    label: workbenchMobilePreviewSemanticLabel,
    child: ExcludeSemantics(
      child: AspectRatio(
        aspectRatio: 10 / 13,
        child: ClipRRect(
          borderRadius: BorderRadius.circular(
            workbenchMobileTokens.cardRadius * 0.72,
          ),
          child: DecoratedBox(
            ...
            child: Padding(
              padding: EdgeInsets.all(workbenchMobileTokens.spacingUnit * 1.25),
              child: Column(
                children: [
                  _PreviewNavigation(colors: colors),
                  SizedBox(height: workbenchMobileTokens.spacingUnit * 1.25),
...
final class _PreviewNavigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    key: const ValueKey<String>('workbench-mobile-preview-navigation'),
    decoration: BoxDecoration(
      color: colors.primaryContainer,
      borderRadius: BorderRadius.circular(workbenchMobileTokens.cardRadius),
    ),
    child: Padding(
      padding: EdgeInsets.symmetric(
        horizontal: workbenchMobileTokens.spacingUnit * 1.25,
        vertical: workbenchMobileTokens.spacingUnit,
      ),
      child: Row(
        children: [
...
final class _PreviewCardStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Stack(
    key: const ValueKey<String>('workbench-mobile-preview-card-stack'),
    fit: StackFit.expand,
    children: [
      Positioned(
        left: workbenchMobileTokens.spacingUnit * 2,
        right: 0,
        top: workbenchMobileTokens.spacingUnit * 1.5,
        bottom: 0,
        child: _PreviewCard(
      ...
      Positioned(
        left: workbenchMobileTokens.spacingUnit,
        right: workbenchMobileTokens.spacingUnit,
        top: workbenchMobileTokens.spacingUnit * 0.75,
        bottom: workbenchMobileTokens.spacingUnit * 0.75,
        child: _PreviewCard(
      ...
      Positioned.fill(
        right: workbenchMobileTokens.spacingUnit * 2,
        bottom: workbenchMobileTokens.spacingUnit * 1.5,
        child: _PreviewCard(
...
final class _PreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: Padding(
        padding: EdgeInsets.all(workbenchMobileTokens.spacingUnit * 1.5),
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: workbenchMobileTokens.spacingUnit * 0.75),
...
final class _PreviewComposer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DecoratedBox(
    key: const ValueKey<String>('workbench-mobile-preview-composer'),
    decoration: BoxDecoration(
      color: colors.surfaceContainerLowest,
      borderRadius: BorderRadius.circular(workbenchMobileTokens.cardRadius),
