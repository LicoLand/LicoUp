...
final class WorkbenchDesktopSearch extends StatefulWidget {
  const WorkbenchDesktopSearch({
    super.key,
  ...
  @override
  State<WorkbenchDesktopSearch> createState() => _WorkbenchDesktopSearchState();
}

final class _WorkbenchDesktopSearchState extends State<WorkbenchDesktopSearch> {
  bool _focused = false;
