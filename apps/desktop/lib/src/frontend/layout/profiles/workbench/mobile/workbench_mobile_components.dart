...
final class WorkbenchMobileComponentKit implements LayoutComponentKit {
  const WorkbenchMobileComponentKit();

  @override
  String get styleIdentity => workbenchMobileStyleIdentity;
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                horizontal: workbenchMobileTokens.spacingUnit * 1.5,
  ...
  Widget panel(
    ...
    return Material(
      ...
      elevation: emphasized ? workbenchMobileTokens.elevation : 0,
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(workbenchMobileTokens.spacingUnit * 2),
        child: child,
      ),
    );
  }
  ...
  Widget card(
    ...
    final content = Padding(
      padding: EdgeInsets.all(workbenchMobileTokens.spacingUnit * 1.75),
      child: child,
    );
    ...
    return Semantics(
      ...
      child: Material(
        ...
        elevation: workbenchMobileTokens.elevation,
        shadowColor: colors.shadow.withValues(alpha: 0.12),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(
            workbenchMobileTokens.cardRadius * 0.84,
          ),
    ...
    return Semantics(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(
            workbenchMobileTokens.cardRadius * 0.64,
          ),
          border: Border.all(
  ...
  Widget dialogSurface(
    ...
    return Material(
      ...
      elevation: workbenchMobileTokens.elevation * 3,
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(workbenchMobileTokens.spacingUnit * 2.5),
        child: child,
      ),
    );
  }
