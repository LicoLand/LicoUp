...
final class BubbleMobileComponentKit implements LayoutComponentKit {
  const BubbleMobileComponentKit();

  @override
  String get styleIdentity => bubbleMobileStyleIdentity;
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              constraints: const BoxConstraints(
                minWidth: BubbleMobileMetrics.touchTargetExtent,
                minHeight: BubbleMobileMetrics.touchTargetExtent,
              ),
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          left: BorderSide(
            ...
            width: emphasized ? 3 : BubbleMobileMetrics.hairline,
          ),
  ...
  Widget card(
    ...
    final shape = RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(BubbleMobileMetrics.controlRadius),
  ...
  Widget dialogSurface(
    ...
    return Material(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(BubbleMobileMetrics.compactRadius),
        side: BorderSide(color: colors.line, width: 1),
      ),
      clipBehavior: Clip.antiAlias,
      child: child,
