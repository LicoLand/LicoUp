...
/// The complete styled component recipe for the Classic mobile profile.
///
...
final class ClassicMobileComponentKit implements LayoutComponentKit {
  const ClassicMobileComponentKit();

  @override
  String get styleIdentity => classicMobileStyleIdentity;
  ...
  Widget navigationItem(
    ...
    final labelStyle = baseLabelStyle?.copyWith(
      ...
      fontSize:
          (baseLabelStyle.fontSize ?? 14) * classicMobileTokens.typographyScale,
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                horizontal: classicMobileTokens.spacingUnit * 1.5,
  ...
  Widget panel(
    ...
    return Material(
      ...
      elevation: emphasized ? classicMobileTokens.elevation : 0,
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(classicMobileTokens.spacingUnit * 2),
        child: child,
      ),
    );
  }
  ...
  Widget card(
    ...
    final content = Padding(
      padding: EdgeInsets.all(classicMobileTokens.spacingUnit * 1.75),
      child: child,
    );
    ...
    return Semantics(
      ...
      child: Material(
        ...
        elevation: classicMobileTokens.elevation,
        shadowColor: colors.shadow.withValues(alpha: 0.12),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(
            classicMobileTokens.cardRadius * 0.84,
          ),
    ...
    return Semantics(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(
            classicMobileTokens.cardRadius * 0.64,
          ),
          border: Border.all(
  ...
  Widget dialogSurface(
    ...
    return Material(
      ...
      elevation: classicMobileTokens.elevation * 3,
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(classicMobileTokens.spacingUnit * 2.5),
        child: child,
      ),
    );
  }
