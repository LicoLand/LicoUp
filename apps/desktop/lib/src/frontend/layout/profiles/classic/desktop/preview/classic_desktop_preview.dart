...
Widget buildClassicDesktopPreview(BuildContext context) =>
    const ClassicDesktopPreview();

/// A deterministic, non-interactive thumbnail of the classic composition.
final class ClassicDesktopPreview extends StatelessWidget {
  const ClassicDesktopPreview({super.key});

  @override
  Widget build(BuildContext context) {
    final colors = Theme.of(context).colorScheme;
    final strings = LicoStrings.of(context);
    final label = strings.isChinese ? '工作台桌面布局预览' : 'Classic desktop preview';

    return Semantics(
      key: const ValueKey<String>('classic-desktop-preview'),
      image: true,
      label: label,
