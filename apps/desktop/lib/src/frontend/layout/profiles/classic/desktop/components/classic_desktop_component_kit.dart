...
/// Card-oriented component recipes owned exclusively by the desktop classic.
final class ClassicDesktopComponentKit implements LayoutComponentKit {
  const ClassicDesktopComponentKit();

  @override
  String get styleIdentity => 'spacious-card-classic';
