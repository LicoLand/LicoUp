...
const String dashboardMobileStyleIdentity = 'spacious-card-dashboard';
const String dashboardMobileRestorationPrefix = 'dashboard.mobile';

final LayoutVisualTokens dashboardMobileTokens = LayoutVisualTokens(
  spacingUnit: 8,
  density: 1,
  cardRadius: 24,
  elevation: 1,
...
/// Dashboard-only measurements. Colors continue to come from the active
...
abstract final class DashboardMobileMetrics {
  ...
  static double interactiveExtent(LayoutEnvironment environment) {
    ...
    return math.max(
      dashboardMobileTokens.navigationExtent,
  ...
  static Duration motionDuration(LayoutEnvironment environment) =>
      ...
      ? Duration.zero
      : dashboardMobileTokens.motionDuration;
}
