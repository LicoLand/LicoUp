...
const LayoutAgentsPresentation studioMobileAgentsPresentation =
    StudioMobileAgentsPresentation();
const LayoutSettingsPresentation studioMobileSettingsPresentation =
    StudioMobileSettingsPresentation();

/// Mobile Studio owns its presentation independently from desktop Studio.
final class StudioMobileAgentsPresentation implements LayoutAgentsPresentation {
  const StudioMobileAgentsPresentation();
...
final class StudioMobileSettingsPresentation
    implements LayoutSettingsPresentation {
  const StudioMobileSettingsPresentation();
