...
final class StudioMobilePreview extends StatelessWidget {
  const StudioMobilePreview({super.key});
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(
                StudioMobileMetrics.compactRadius,
              ),
              border: Border.all(color: colors.line, width: 1),
            ),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(
                StudioMobileMetrics.compactRadius - 1,
              ),
              child: ExcludeSemantics(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return Row(
                      children: [
                        _StudioPreviewRail(compact: compact),
                        Expanded(
                          child: _StudioPreviewWorkspace(compact: compact),
                        ),
                      ],
                    );
                  },
...
final class _StudioPreviewRail extends StatelessWidget {
  const _StudioPreviewRail({required this.compact});
...
final class _StudioPreviewWorkspace extends StatelessWidget {
  const _StudioPreviewWorkspace({required this.compact});
...
final class _StudioPreviewLine extends StatelessWidget {
  const _StudioPreviewLine({
