...
/// Studio-owned recipes. The straight edges and hairline separators keep
/// controls visually integrated with the dock instead of turning into cards.
final class StudioDesktopComponentKit implements LayoutComponentKit {
  const StudioDesktopComponentKit();

  @override
  String get styleIdentity => 'dense-docked-studio';
              ...
              builder: (context, constraints) {
                ...
                return AnimatedContainer(
                  ...
                  constraints: const BoxConstraints(
                    minHeight: StudioDesktopMetrics.navigationItemExtent,
                  ),
    ...
    return Semantics(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
          minHeight: math.max(
            StudioDesktopMetrics.fieldMinimumExtent,
            StudioDesktopMetrics.fieldMinimumExtent *
  ...
  Widget dialogSurface(
    ...
    return ConstrainedBox(
      key: key,
      constraints: const BoxConstraints(
        maxWidth: StudioDesktopMetrics.dialogMaximumWidth,
      ),
      child: Material(
