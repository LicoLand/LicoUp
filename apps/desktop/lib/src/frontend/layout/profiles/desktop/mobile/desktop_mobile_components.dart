...
final class DesktopMobileComponentKit implements LayoutComponentKit {
  const DesktopMobileComponentKit();

  @override
  String get styleIdentity => desktopMobileStyleIdentity;
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                horizontal: desktopMobileTokens.spacingUnit * 1.5,
  ...
  Widget panel(
    ...
    return Material(
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(desktopMobileTokens.spacingUnit * 2),
        child: child,
      ),
    );
  }
  ...
  Widget card(
    ...
    final content = Padding(
      padding: EdgeInsets.all(desktopMobileTokens.spacingUnit * 1.75),
      child: child,
    );
  ...
  Widget dialogSurface(
    ...
    return Material(
      ...
      clipBehavior: Clip.antiAlias,
      child: Padding(
        padding: EdgeInsets.all(desktopMobileTokens.spacingUnit * 2.5),
        child: child,
      ),
    );
  }
