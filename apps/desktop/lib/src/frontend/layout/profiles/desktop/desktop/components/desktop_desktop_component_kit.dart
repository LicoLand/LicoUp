...
final class DesktopDesktopComponentKit implements LayoutComponentKit {
  ...
  /// Resolved from the profile descriptor so the kit and the bundle can never
  /// drift apart when the profile identity migrates.
  @override
  String get styleIdentity => BuiltInLayoutSpec.desktop.styleIdentity;
