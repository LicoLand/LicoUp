...
const String desktopMobileStyleIdentity = 'spacious-card-desktop';
const String desktopMobileRestorationPrefix = 'desktop.mobile';

final LayoutVisualTokens desktopMobileTokens = LayoutVisualTokens(
  spacingUnit: 8,
  density: 1,
  cardRadius: 24,
  elevation: 1,
...
/// Desktop-only measurements. Colors continue to come from the active
/// appearance theme so presentation identity and appearance stay orthogonal.
abstract final class DesktopMobileMetrics {
  ...
  static double interactiveExtent(LayoutEnvironment environment) {
    ...
    return math.max(
      desktopMobileTokens.navigationExtent,
  ...
  static Duration motionDuration(LayoutEnvironment environment) =>
      ...
      ? Duration.zero
      : desktopMobileTokens.motionDuration;
}
