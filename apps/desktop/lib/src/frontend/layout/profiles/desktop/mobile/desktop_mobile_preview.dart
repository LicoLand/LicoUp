...
Widget buildDesktopMobilePreview(BuildContext context) {
  final colors = Theme.of(context).colorScheme;
  return Semantics(
    key: const ValueKey<String>('desktop-mobile-preview'),
    container: true,
    image: true,
    label: desktopMobilePreviewSemanticLabel,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: desktopMobileTokens.spacingUnit * 1.25),
...
final class _PreviewNavigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    key: const ValueKey<String>('desktop-mobile-preview-navigation'),
    decoration: BoxDecoration(
    ...
    child: Padding(
      padding: EdgeInsets.symmetric(
        horizontal: desktopMobileTokens.spacingUnit * 1.25,
        vertical: desktopMobileTokens.spacingUnit,
      ),
      child: Row(
        children: [
...
final class _PreviewCardStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Stack(
    key: const ValueKey<String>('desktop-mobile-preview-card-stack'),
    fit: StackFit.expand,
    children: [
      Positioned(
        left: desktopMobileTokens.spacingUnit * 2,
        right: 0,
        top: desktopMobileTokens.spacingUnit * 1.5,
        bottom: 0,
        child: _PreviewCard(
      ...
      Positioned(
        left: desktopMobileTokens.spacingUnit,
        right: desktopMobileTokens.spacingUnit,
        top: desktopMobileTokens.spacingUnit * 0.75,
        bottom: desktopMobileTokens.spacingUnit * 0.75,
        child: _PreviewCard(
      ...
      Positioned.fill(
        right: desktopMobileTokens.spacingUnit * 2,
        bottom: desktopMobileTokens.spacingUnit * 1.5,
        child: _PreviewCard(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: desktopMobileTokens.spacingUnit * 0.75),
