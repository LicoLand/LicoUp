...
class LicoStrings {
  ...
  String get controlPanel => isChinese ? '动态' : 'Home';
  String get controlPanelSubtitle => isChinese
      ? '智能体汇报与用户发帖会按时间出现在这里。'
      : 'Agent reports and your posts appear here in chronological order.';
  String get openAgents => isChinese ? '打开智能体' : 'Open Agents';
  String get configureMcpPlugins =>
      isChinese ? '配置 MCP 插件' : 'Configure MCP Plugins';
  ...
  String get feed => isChinese ? '广场' : 'Feed';
  ...
  String get officialApiStatus => isChinese ? '官方接口状态' : 'Official API Status';
  String get directApi => isChinese ? '直连' : 'Direct';
  String get consoleApi => isChinese ? '控制台' : 'Local API';
  ...
  /// Merged nav label for plugins + skill hub.
  String get extensionsHub => isChinese ? '插件与技能' : 'Plugins & Skills';
