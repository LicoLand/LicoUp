...
class ConversationMetadataFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (rows.isEmpty) {
      return Text(data, style: TextStyle(color: foreground, fontSize: 11.5));
    }
    return Column(
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            value,
            style: TextStyle(color: valueColor, fontSize: 11.5, height: 1.35),
          ),
        ),
      ],
    );
...
List<({String key, String value})> parseConversationMetadataFields(
  String data,
) {
