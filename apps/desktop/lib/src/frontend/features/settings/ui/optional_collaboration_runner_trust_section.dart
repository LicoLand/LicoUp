      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.isChinese
                  ? '信任根只用于验证指定 GitHub 仓库中、固定 identity 的 LicoLite runner。导入不会下载、安装、组装或启动 runner。'
                  : 'This trust root verifies only the fixed-identity LicoLite runner from the named GitHub repository. Import does not download, install, assemble, or start a runner.',
