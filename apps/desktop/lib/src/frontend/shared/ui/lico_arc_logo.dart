...
class LicoArcLogo extends StatelessWidget {
  const LicoArcLogo({super.key, this.size = 24, this.opacity = 1});
  ...
  Widget build(BuildContext context) {
    return Opacity(
      ...
      child: SizedBox.square(
        dimension: size,
        child: const CustomPaint(painter: _LicoArcLogoPainter()),
      ),
    );
  }
}

class _LicoArcLogoPainter extends CustomPainter {
  const _LicoArcLogoPainter();
  ...
  @override
  bool shouldRepaint(covariant _LicoArcLogoPainter oldDelegate) => false;
