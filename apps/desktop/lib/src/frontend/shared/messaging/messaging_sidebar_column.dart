...
final class MessagingSidebarColumn extends StatelessWidget {
  ...
  final LayoutAgentsPresentation? presentation;

  @override
  Widget build(BuildContext context) {
    final geometry = MessagingSidebarGeometryScope.maybeOf(context);
    final resolvedPresentation =
        presentation ?? layoutAgentsPresentationOf(context);
    return LayoutBuilder(
      builder: (context, constraints) {
        final maxSidebarWidth = math
            .max(
              ...
              constraints.maxWidth -
                  ...
                  resolvedPresentation.sidebarOuterHorizontalExtent -
                  resolvedPresentation.detailOuterHorizontalExtent,
            )
            .clamp(
              MessagingDesktopMetrics.conversationListMinExtent,
              MessagingDesktopMetrics.conversationListMaxExtent,
        ...
        return Row(
          ...
          children: [
            if (!sidebarCollapsed)
              resolvedPresentation.frameSidebar(
                context,
