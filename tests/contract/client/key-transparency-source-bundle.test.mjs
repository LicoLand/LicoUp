...
const facadePath = "crates/lico-client-native/src/domain/mobile_relay/key_transparency.rs";
const moduleRoot = "crates/lico-client-native/src/domain/mobile_relay/key_transparency";
