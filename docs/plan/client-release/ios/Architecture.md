...
pinned Xcode/Flutter toolchain → Apple-silicon simulator app
  ...
  → separately blocked physical archive/custody → Apple distribution/TestFlight/store
...
real biometrics, device encryption and distribution remain fail-closed; projected callback support
is never promoted into those claims.
