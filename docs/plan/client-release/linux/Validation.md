...
5. Sign/attest, publish and download the same digest; repeat install/launch and verify update/rollback continuity. Run the privacy scan after the final producer.
...
REQ-LIN-001 is proven by steps 1–2; REQ-LIN-002 by step 3; REQ-LIN-003 by step 4; REQ-LIN-004 by step 5.
