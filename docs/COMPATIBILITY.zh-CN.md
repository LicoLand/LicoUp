...
| claude-code | conversation | ready | 是 | claude-code-cli-stream-json | stream-json | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
...
| cursor | conversation | ready | 是 | cursor-agent-cli-v1 | cli | 是 | 是 | 是 | 否 | 是 | 是 | 否 |
