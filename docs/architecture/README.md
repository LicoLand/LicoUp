...
| **Workflow control and compiler** | [ASSISTANT-WORKFLOW-CONTROL.md](ASSISTANT-WORKFLOW-CONTROL.md) | Target compiler layers, Proxy, node publish/subscribe and graceful intervention |
