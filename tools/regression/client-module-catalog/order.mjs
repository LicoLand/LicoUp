export const CLIENT_MODULE_ID_ORDER = Object.freeze([
  ...
  "flutter.contract.orchestration-policy.models",
  "flutter.contract.orchestration-policy.codec",
  "flutter.contract.orchestration-policy.catalog",
  "flutter.contract.orchestration-policy.validation",
  "flutter.contract.orchestration-policy.merge",
  "flutter.contract.orchestration-policy.target",
  "flutter.contract.orchestration-policy.boundary",
  ...
  "flutter.feature.routing.distillation.package-models",
  "flutter.feature.routing.distillation.usage-audit",
  "flutter.feature.routing.distillation.result-models",
  "flutter.feature.routing.distillation.semantics",
  "flutter.feature.routing.distillation.utf8",
  "flutter.feature.routing.distillation.input-window",
  "flutter.feature.routing.distillation.source-content",
  "flutter.feature.routing.distillation.fidelity-reducer",
  "flutter.feature.routing.distillation.lane-contract",
  ...
  "flutter.feature.skill-hub.update",
  "flutter.feature.skill-hub.auto-update-scheduler",
  ...
  "flutter.controller.assembly.routing",
  ...
  "flutter.controller.scenario.routing",
  ...
  "rust.domain.mobile-relay.relay-operations.context",
  "rust.domain.mobile-relay.relay-operations.mailbox",
  "rust.domain.mobile-relay.relay-operations.envelope",
  "rust.domain.mobile-relay.relay-operations.registration",
  ...
  "rust.domain.skill-hub.update",
  "rust.domain.skill-hub.auto-update",
  "rust.domain.skill-hub.delete",
  "rust.domain.skill-hub.usage",
  "rust.domain.skill-hub.source",
  ...
  "rust.core.secure-mesh.skill-sync",
  ...
  "regression.secure-client-relay-source-bundle",
  ...
  "rust.bin.lico-client",
  "rust.bin.lico-client.rpc",
  "rust.bin.lico-client.core-commands",
  "rust.bin.lico-client.skill-commands",
  "rust.bin.lico-client.conversation-commands",
  "rust.bin.lico-client.parsing",
