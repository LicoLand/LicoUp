...
export const RUST_PLATFORM_MODULES = Object.freeze([
  ...
  defineModule({
      ...
      kind: "rust-platform",
      summary: "Unattended server-request decline without aborting the native turn",
      inputs: [
  ...
  defineModule({
      ...
      inputs: [
        ...
        "crates/licoup-native/src/platform/native_agent_parser/adapters/driver_registry.rs",
        ...
        "crates/licoup-native/src/platform/native_agent_parser/lifecycle.rs",
        "crates/licoup-native/src/platform/native_agent_parser/mod.rs",
        "crates/licoup-native/src/platform/native_agent_parser/reconciliation.rs",
        "crates/licoup-native/src/platform/native_agent_parser/registry.rs",
        ...
        "crates/licoup-native/src/platform/provider_mcp_registration.rs",
        ...
        "crates/licoup-native/src/platform/cursor_subagent_mcp_manager.rs",
        "crates/licoup-native/src/platform/generic_cli_driver.rs",
        ...
        "crates/licoup-native/src/platform/subagent_mcp_host_client.rs",
        ...
        "crates/licoup-native/tests/adapter_replay.rs",
        "crates/licoup-native/resources/agent-conversation-drivers.json",
  ...
  defineModule({
      id: "rust.bin.licoup.subagent-mcp-startup",
      kind: "rust-ffi",
      summary: "Desktop startup owns the persistent conversation host and Subagent MCP service lifecycle before any conversation action",
      inputs: [
        "crates/licoup-native/tests/subagent_mcp_startup.rs",
        "crates/licoup-native/src/bin/licoup/conversation_host.rs",
      ],
      command: rustIntegrationTest("subagent_mcp_startup"),
    }),
  defineModule({
      ...
      inputs: [
        "crates/licoup-native/src/contracts/conversation_protocol.rs",
        "crates/licoup-native/src/contracts/frame.rs",
        "crates/licoup-native/src/contracts/mod.rs",
