...
const correctiveReleaseNotes = [
  ...
  "",
  "The macOS app uses the long-lived self-signed LicoUp Release identity. On first launch, macOS may require explicit trust in Privacy & Security settings.",
  "This release does not claim Apple Developer ID signing or notarization.",
  "",
