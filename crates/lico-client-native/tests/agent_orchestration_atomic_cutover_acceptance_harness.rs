...
fn assert_production_builder_linkage_and_real_authority() {
    ...
    const DESKTOP_STDIO_HANDLER: &str = include_str!("../src/bin/lico-client/stdio_rpc/server.rs");
    const CLI_HANDLER: &str = include_str!("../src/bin/lico-client/orchestrator.rs");
