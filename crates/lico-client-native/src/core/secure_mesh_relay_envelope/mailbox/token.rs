//! Canonical fixed-size base64url mailbox token.
...
pub struct SecureMeshMailboxToken {
    pub(in crate::core::secure_mesh_relay_envelope) value: String,
    pub(in crate::core::secure_mesh_relay_envelope) epoch: u64,
}
...
impl SecureMeshMailboxToken {
    ...
    #[cfg(test)]
    pub(in crate::core::secure_mesh_relay_envelope) fn epoch(&self) -> u64 {
        self.epoch
    }
}
