...
pub(in crate::core::secure_mesh_relay_envelope) fn encode_private_relay_header_frame(
    private_header: &[u8],
...
pub(in crate::core::secure_mesh_relay_envelope) fn decode_private_relay_header_frame(
