...
pub(super) const HKDF_SALT_DOMAIN: &[u8] = b"licolite.secure-mesh.payload-aead.hkdf-salt.v1";
pub(super) const HKDF_INFO_DOMAIN: &[u8] = b"licolite.secure-mesh.payload-aead.hkdf-info.v1";
