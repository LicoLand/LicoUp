...
pub(super) const FILE_KEY_ENVELOPE_SCHEMA: &str = "licolite.secure-mesh.file-key-envelope.v2";
...
pub(super) const FILE_HKDF_SALT: &[u8] = b"licolite.secure-mesh.file.hkdf-salt.v2";
pub(super) const FILE_HKDF_MANIFEST_DOMAIN: &[u8] = b"licolite.secure-mesh.file.manifest-key.v2";
pub(super) const FILE_HKDF_CHUNK_DOMAIN: &[u8] = b"licolite.secure-mesh.file.chunk-key.v2";
pub(super) const FILE_HKDF_CHUNK_HASH_DOMAIN: &[u8] =
    b"licolite.secure-mesh.file.chunk-hash-key.v2";
pub(super) const FILE_HKDF_RECEIPT_DOMAIN: &[u8] = b"licolite.secure-mesh.file.receipt-key.v2";
pub(super) const FILE_HKDF_KEY_WRAP_DOMAIN: &[u8] = b"licolite.secure-mesh.file.key-wrap-key.v2";
