use lico_client_native::ffi::generated::client_error::{
    ClientError, ClientErrorCode, ClientErrorComponent, ClientErrorRecovery, ClientErrorStage,
};
use lico_client_native::ffi::generated::client_state::ClientStateFailure;
...
pub(crate) fn stdio_rpc_command_error(error: &anyhow::Error) -> ClientError {
    ...
    if let Some(error) = error.downcast_ref::<lico_client_native::ffi::commands::CliCommandError>()
    {
