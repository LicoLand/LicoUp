...
use lico_client_native::core::secure_mesh_directory::{
    SecureMeshDirectoryLeafClaim, UntrustedDirectoryAbsenceResponse, UntrustedDirectoryResponse,
};
use lico_client_native::core::secure_mesh_transparency::{
...
fn consistency(
    ...
    first_tree_size: Option<u64>,
    issued_at: u64,
) -> Result<Option<lico_client_native::core::secure_mesh_transparency::SecureMeshKtConsistencyProof>>
{
