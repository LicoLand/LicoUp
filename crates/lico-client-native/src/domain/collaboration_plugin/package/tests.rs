...
fn workflow_descriptor_cannot_smuggle_an_executable_directive() {
    ...
    fs::write(
            ...
            br#"{"schemaVersion":"licoarc.collaboration.local-deployment.v1","manualOnly":true,"features":[{"id":"server-core","label":"Server Core","packagePath":"payload/server-core"}],"command":"run-me"}"#,
        )
        .unwrap();
