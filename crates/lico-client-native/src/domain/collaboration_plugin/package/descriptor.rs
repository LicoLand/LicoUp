...
pub(super) const LOCAL_DEPLOYMENT_SCHEMA: &str = "licoarc.collaboration.local-deployment.v1";
pub(super) const MCP_INSTALL_SCHEMA: &str = "licoarc.collaboration.mcp-install.v2";
