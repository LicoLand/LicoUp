...
pub(super) const REGISTRATION_SCHEMA: &str = "licoarc.mcp-agent-registration.v2";
...
pub(super) const BRIDGE_KIND: &str = "licoarc-stdio-mcp-gate";
...
fn authority_binding_for_record(
    ...
    Ok(AuthorityRegistration {
        ...
        selected_plugin_inventory_digest_sha256: scoped_digest(
            b"LICOARC-MCP-SELECTED-PLUGIN-INVENTORY-V1\0",
            record
                .selected_plugin_ids
                .iter()
        ...
        endpoint_scope_digest_sha256: scoped_digest(
            b"LICOARC-MCP-ENDPOINT-SCOPE-V1\0",
        ...
        payload_inventory_digest_sha256: scoped_digest(
            b"LICOARC-MCP-PAYLOAD-INVENTORY-V1\0",
        ...
        agent_destination_digest_sha256: scoped_digest(
            b"LICOARC-MCP-AGENT-DESTINATION-V1\0",
            [vec![
        ...
        registration_destination_digest_sha256: scoped_digest(
            b"LICOARC-MCP-REGISTRATION-DESTINATION-V1\0",
            [vec![
                record.agent_id.clone(),
