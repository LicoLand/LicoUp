...
const ENTRY_SCHEMA: &str = "licoarc.authorized-secure-ledger-entry.v1";
...
impl LedgerEntry {
    ...
    fn expected_digest(&self) -> Result<String> {
        ...
        hasher.update(b"LICOARC-AUTHORIZED-SECURE-LEDGER-ENTRY-V1\0");
...
pub(super) fn locator_digest(locator: &SecureRecordLocator) -> String {
    let mut hasher = Sha256::new();
    hasher.update(b"LICOARC-AUTHORIZED-SECURE-LEDGER-LOCATOR-V1\0");
