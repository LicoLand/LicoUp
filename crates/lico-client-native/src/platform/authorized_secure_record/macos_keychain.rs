...
const SERVICE_PREFIX: &str = "com.lico.client.authorized-ledger.v1";
const EXPECTED_BUNDLE_IDENTIFIER: &str = "com.lico.client";
const PROOF_SCHEMA: &str = "licoarc.authorized-secure-ledger-proof.v1";
