...
pub const CLIENT_UPDATE_REVOCATION_SCHEMA: &str = "v0.0.1:client-update:revocation-list-1";
pub const CLIENT_UPDATE_ARTIFACT_RECEIPT_SCHEMA: &str = "v0.0.1:client-update:artifact-receipt-1";
