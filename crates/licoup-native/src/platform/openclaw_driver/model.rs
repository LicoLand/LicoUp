...
pub(in crate::platform) const RUNTIME_PROTOCOL: &str = "openclaw-acp-stdio-jsonrpc";
...
impl RunResult {
    pub(super) fn failed(
        ...
        let transitions =
            crate::platform::native_agent_parser::adapters::openclaw::failed_transitions(
                &failure.code,
                &failure.stage,
                &failure.message,
            );
...
pub(in crate::platform) struct CapabilityProbe {
    ...
    pub(in crate::platform) supports_reasoning: bool,
