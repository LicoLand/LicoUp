...
pub const SECURE_MESH_RELAY_ENVELOPE_SCHEMA: &str = "licomesh.secure-mesh.relay-envelope.v2";
...
pub(super) const MAX_RELAY_ENVELOPE_JSON_BYTES: usize = ((MAX_PADDING_BUCKET_BYTES + 2) / 3) * 4
    ...
    + 16 * 1024;
pub(super) const MAILBOX_HKDF_SALT: &[u8] = b"licomesh.secure-mesh.mailbox.hkdf-salt.v1";
pub(super) const MAILBOX_HKDF_INFO: &[u8] = b"licomesh.secure-mesh.mailbox.hkdf-info.v1";
