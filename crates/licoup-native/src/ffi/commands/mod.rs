...
fn build_command_table() -> CommandTable {
    ...
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_install_plan",
        path: &["skill", "install", "plan"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        constraints: &[],
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_install_plan,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_install_apply",
        path: &["skill", "install", "apply"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        constraints: &[],
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_install_apply,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_install_rollback",
        path: &["skill", "install", "rollback"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        constraints: &[],
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_install_rollback,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_update_plan",
        path: &["skill", "update", "plan"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_update_plan,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_update_apply",
        path: &["skill", "update", "apply"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_update_apply,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        ...
        constraints: &[
            OptionConstraintSpec {
                kind: OptionConstraintKind::AtLeastOne,
    ...
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_auto_update_set",
        path: &["skill", "auto-update", "set"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_auto_update_set,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_auto_update_run",
        path: &["skill", "auto-update", "run"],
        required_positionals: &[],
        options: &[
            OptionSpec {
                name: "agent",
        ...
        constraints: &[],
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_auto_update_run,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
        handler_name: "handle_skill_auto_update_tick",
        path: &["skill", "auto-update", "tick"],
        required_positionals: &[],
        options: &[],
        constraints: &[],
        cardinality: CommandCardinality::Exact,
        handler: skill::handle_skill_auto_update_tick,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
    ...
    table.register_command(CommandSpec {
        ...
        constraints: &[],
        cardinality: CommandCardinality::Options,
        handler: skill::handle_skill_pin,
        help: "",
    });
    table.register_command(CommandSpec {
        source_module: "skill.rs",
