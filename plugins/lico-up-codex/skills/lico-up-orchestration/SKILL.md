...
description: Preview, submit, wait on, message, approve, or cancel governed workflows through the local LicoUp control plane.
---

# LicoUp orchestration

Use this skill when work should be delegated through a user-configured LicoUp workflow. LicoUp remains the workflow and dispatch authority; this plugin only submits control-plane commands and reads privacy-minimal receipts.
